...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Crew Girl Wiki',
    description: 'Crew Girl Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Netflix series fan resource site. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Crew Girl Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Netflix, YouTube, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Crew Girl Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Netflix or the creators of Crew Girl. All series content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@crewgirl.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@crewgirl.online</a>
            </p>
            <p>
