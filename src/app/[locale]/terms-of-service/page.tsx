...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Crew Girl Wiki",
    description: "Read the Terms of Service for Crew Girl Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Netflix series fan resource site.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Crew Girl Wiki",
      description: "Terms and conditions for using Crew Girl Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Crew Girl Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Crew Girl Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Crew Girl Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Crew Girl Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Netflix series "Crew Girl". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Episode guides and recaps</li>
              <li>Cast and character profiles</li>
              <li>Plot and ending explainers</li>
              <li>Rowing and series details</li>
              <li>Release news and updates</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Crew Girl Wiki is NOT affiliated with, endorsed by, or associated with
              Netflix or the official creators of Crew Girl. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Crew Girl Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Series Content</h3>
            <p>
              All series-related content, including but not limited to character images, promotional stills, logos, and trademarks, are the property of Netflix and/or the creators of Crew Girl. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. New episodes may render information outdated.</li>
              ...
              <li><strong>Content Availability:</strong> Episode availability and release schedules may change without notice. We are not responsible for content removal or platform changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, CREW GIRL WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Netflix, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Crew Girl Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@crewgirl.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@crewgirl.online</a>
            </p>
            <p>
