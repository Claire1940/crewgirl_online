...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Crew Girl Wiki',
    description: 'Copyright and intellectual property information for Crew Girl Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Crew Girl Wiki',
      description: 'Copyright and intellectual property information for Crew Girl Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Crew Girl Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Crew Girl Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Series Assets and Trademarks</h3>
            <p>
              Crew Girl Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Netflix</strong> - Operator of the Netflix streaming platform</li>
              <li><strong>Crew Girl Creators</strong> - Creators of the Crew Girl series</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Promotional stills and key art</li>
              <li>Series logos and branding</li>
              <li>Character names and abilities</li>
              <li>Episode titles and storylines</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Educational:</strong> We help viewers learn more about the series</li>
              <li><strong>Minimal impact:</strong> Our use does not substitute for or harm the original series</li>
            </ul>
            <p>
              We believe our use of copyrighted materials enhances the viewing experience and serves the community
            ...
            <p>
              ...
              affiliation with Crew Girl Wiki.
            </p>
            ...
            <p>
              ...
              Crew Girl Wiki<br />
              Email: <a href="mailto:dmca@crewgirl.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@crewgirl.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Crew Girl Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Crew Girl Wiki (crewgirl.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@crewgirl.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@crewgirl.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@crewgirl.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@crewgirl.online</a>
            </p>
            <p>
